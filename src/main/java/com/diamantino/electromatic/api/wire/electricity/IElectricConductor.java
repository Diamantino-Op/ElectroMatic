...
public interface IElectricConductor extends IElectricDevice, IRedConductor {
    ...
    public static interface IAdvancedElectricConductor extends IElectricConductor {
         ...
         */
        public Collection<Map.Entry<IConnection<IElectricDevice>, Boolean>> propagate(Direction fromSide);
    }
